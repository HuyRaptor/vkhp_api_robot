...
${WAREHOUSE_ID}         6
${PRODUCT_CATEGORY_ID}  37    # Kept as placeholder, though not used for replenishments
${RESULTS_DIR}          ${CURDIR}${/}results
${TEST_REPLENISHMENT_ID}    ${EMPTY}
${TEST_REPLENISHMENT_CODE}  ${EMPTY}
${TEST_REPLENISHMENT_DATA}  ${EMPTY}
