...
04 - Create Replenishment With Priority Test
    ...
    Log                 Successfully created urgent priority replenishment: ${response}[code] with ID: ${TEST_REPLENISH_ID}
...
06 - Create Receipt With Priority Test
    ...
    Log                 Successfully created urgent priority receipt: ${response}[code] with ID: ${TEST_RECEIPT_ID}
...
07 - Create Package With Priority Test
    ...
    Log                 Successfully created urgent priority package with ID: ${TEST_PACKAGE_ID}
