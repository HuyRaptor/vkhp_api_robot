...
12 - Cleanup Test Environment
    ...
    # Delete test package if it exists
    Run Keyword If    "${TEST_PACKAGE_ID}" != "${EMPTY}"    Delete Package    ${TEST_PACKAGE_ID}
    
    # Reset test data variables
    Set Test Variable    ${TEST_PACKAGE_ID}    ${EMPTY}
    Set Test Variable    ${TEST_PACKAGE_DATA}    ${EMPTY}
    Set Test Variable    ${TEST_PACKAGE_UPDATED_DATA}    ${EMPTY}
